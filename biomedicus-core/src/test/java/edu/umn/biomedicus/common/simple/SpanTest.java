...
public class SpanTest {
    ...
    public void testCompareToDifferentBegin() throws Exception {
        SpanLike tested = new Span(10, 15);
        SpanLike other = new Span(6, 10);
        assertNotEquals(tested.compare(other), 0, "Comparing spans with different values should not return 0");
    }
    ...
    public void testCompareToEquals() throws Exception {
        SpanLike tested = new Span(10, 15);
        SpanLike other = new Span(10, 15);
        assertEquals(tested.compare(other), 0, "Comparing spans with same values should return 0");
    }
}