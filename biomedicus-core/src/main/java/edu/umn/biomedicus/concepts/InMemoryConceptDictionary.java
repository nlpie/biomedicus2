...
import edu.umn.biomedicus.concepts.InMemoryConceptDictionary.Loader;
...
class InMemoryConceptDictionary implements LifecycleManaged {

  private static final Logger LOGGER = LoggerFactory.getLogger(InMemoryConceptDictionary.class);
  ...
  @Singleton
  static final class Loader extends DataLoader<InMemoryConceptDictionary> {
    ...
    @Override
    protected InMemoryConceptDictionary loadModel() throws BiomedicusException {
      ...
      return new InMemoryConceptDictionary(volumes, normDictionary, phrases, lowercase);
    }
  }
}
