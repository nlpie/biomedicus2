...
public final class LabelsUtilities {
  ...
  /**
   * Changes the type bound to that of a superclass of the current bound. This works because
   * labelIndex collections are immutable and thus the bounded type is covariant.
   *
  ...
  /**
   * Changes the type bound to that of a superclass of the current bound. This works because labels
   * objects are immutable and thus the bounded type is covariant.
   *
