...
public interface LabelIndex<T> extends Collection<Label<T>> {
     ...
     * @return LabelIndex object filtered down so that all labels meet the
     * requirement
     */
    ...
    /**
     * Returns a LabelIndex which ascends based on the begin value of label
     * objects.
     *
     ...
     * @return an optional of the label with the text location, empty if no
     * label has that location
     */
     ...
     * ascending than end ascending by default, and can be modified through the
     * {@link #descendingBegin()} and {@link #descendingEnd()} methods.
     *
    ...
    /**
     * Either put all of the spans in a list or provide a list view of the
     * spans.
     *
