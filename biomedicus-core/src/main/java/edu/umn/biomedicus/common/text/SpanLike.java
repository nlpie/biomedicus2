 ...
 * substring represented by this SpanLike will be the same as calling {@link String#substring(int, int)} with the
...
public interface SpanLike {
     ...
     */
    default Span relativize(SpanLike other) {
     ...
     */
    default Span derelativize(SpanLike other) {
    ...
    default boolean isContainedBy(SpanLike other) {
