...
/**
 * Responsible for copying the FeatureStructures of one UIMA CAS view to another. Has a queue and map which tracks
 * the current progress iterating through all FeatureStructures.
 *
 * @author Ben Knoll
 * @since 1.3.0
 */
class FeatureStructureCopyingQueue {
     ...
     * @param fsMap map from feature structures in the source CAS to feature structures in the destination CAS
     */
    ...
    /**
     * Constructor which takes the destination view. Initializes the {@code FsCopiers} and {@code FsConstructors}
     * fields using new objects. Initializes the queue using {@link ArrayDeque} and the map using {@link HashMap}.
     *
