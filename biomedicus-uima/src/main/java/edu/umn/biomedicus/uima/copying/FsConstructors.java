...
class FsConstructors {
    ...
    /**
     * Constructor for {@code FsConstructors} which creates the {@code FeatureStructure}s in the designated {@link CAS}
     * object.
     *
     ...
     *
     * @param featureStructure {@code FeatureStructure} to create a new object of the same type in the target cas.
     * @return newly created {@code FeatureStructure} matching the type of the parameter {@code FeatureStructure}
     */
