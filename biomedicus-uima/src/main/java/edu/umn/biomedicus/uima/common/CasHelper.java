...
public final class CasHelper {
  ...
  /**
   * Provides a stream of the {@link FeatureStructure} objects of a specific type by getting all
   * indexed FSes of the type from the index repository.
   *
  ...
  /**
   * Provides a stream of the {@link FeatureStructure} objects of a specific type  name by getting
   * all indexed FSes the type from the index repository.
   *
