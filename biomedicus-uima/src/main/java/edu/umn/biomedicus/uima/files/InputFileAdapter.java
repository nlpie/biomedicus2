...
/**
 * Interface used to adapt a file to a CAS document. Implementations must have a public 0-arg
 * constructor.
 *
 * @since 1.3.0
 */
public interface InputFileAdapter {
   ...
   */
  default void initialize(UimaContext uimaContext,
  ...
  /**
   * Sets the view to load data into. This is an optional method. Some adapters by design may not
   * have a target view, for example, deserializers that handle the entire CAS object.
   *
