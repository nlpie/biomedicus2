...
/**
 * A character or control word in the original document. Stores information about the destination it
 * maps to and the distance from the previous symbol that maps to a destination.
 *
 * @author Ben Knoll
 * @since 1.4.0
 */
class SymbolLocation {
  ...
  /**
   * The distance in number of characters from the previous symbol in the original document that
   * maps to an output destination.
   */
  private int offset;
   ...
   * @param offset the distance in number of characters from the previous symbol that maps to a
   * destination.
