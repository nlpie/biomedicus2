...
/**
 * A UIMA analysis engine that writes the sofa for the view named {@link Views#SYSTEM_VIEW} to a
 * text file.
 */
public class PlainTextWriter extends JCasAnnotator_ImplBase {
   ...
   * @throws ResourceInitializationException if our writer factory fails to set the output
   * directory
   */
  @Override
