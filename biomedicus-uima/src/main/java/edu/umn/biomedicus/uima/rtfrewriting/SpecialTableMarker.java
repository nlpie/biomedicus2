...
/**
 * Inserts a marker at the end of a special table (color table, stylesheet, etc) in rtf, along with
 * the number of entries that table contains.
 *
 * @author Ben Knoll
 * @since 1.4.0
 */
public class SpecialTableMarker {
  ...
  /**
   * Creates a {@code SpecialTableMarker}, which will insert a character and a number of the entries
   * that a table contains.
   *
   ...
   *
   * @return document with the character and count of existing entries inserted at the end of the
   * table.
   */
  public String insertInTable() throws SpecialTableNotFoundException {
    ...
    return document.substring(0, characterIndex) + insertionString + " " + tableIndex + document
