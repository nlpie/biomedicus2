 ...
 * @since 1.3.0
 */
public class PropertyCasMappingAdapter extends XmlAdapter<AdaptedPropertyCasMapping, PropertyCasMapping> {
    @Override
    public PropertyCasMapping unmarshal(AdaptedPropertyCasMapping v) throws Exception {
        return new PropertyCasMapping(requireNonNull(v.getPropertyGroup()), requireNonNull(v.getPropertyName()),
