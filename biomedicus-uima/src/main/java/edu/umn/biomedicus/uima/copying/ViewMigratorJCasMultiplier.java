...
public class ViewMigratorJCasMultiplier extends JCasMultiplier_ImplBase {
    ...
    /**
     * {@inheritDoc}
     * <p>Initializes the 3 parameters, "sourceViewName", "targetViewName", and "deleteOriginalView".</p>
     */
    @Override
    ...
    /**
     * {@inheritDoc}
     * <p>Performs the copying of all views in the old view to a new view, and also for the specified view creates a new
     * view optionally copying the old view twice, once to the new name, once to the existing name</p>
     */
    @Override
    public void process(JCas aJCas) throws AnalysisEngineProcessException {
        ...
        while (viewIterator.hasNext()) {
            ...
            JCas newView;
            try {
                newView = CAS.NAME_DEFAULT_SOFA.equals(viewName) ? newJCas.getView(viewName): newJCas.createView(viewName);
            } catch (CASException e) {
                throw new AnalysisEngineProcessException(e);
            }
