...
public class State {
    ...
    /**
     * Initializes a new state given the map of output destinations, a factory for new output destinations, and the
     * state properties.
     *
    ...
    public State copy() {
        ...
        State stateCopy = new State(outputDestinationMap, outputDestinationFactory, propertiesCopy, indexListener);
     ...
     */
    public void writeCharacter(int code, TextLocation originalDocumentTextLocation) throws RtfReaderException {
        ...
        switch (inputType) {
            ...
            case HEX:
                ...
                if (hexStringBuilder.length() == 2) {
                    ...
                    directWriteCharacter((char) code, Span.create(hexStart, originalDocumentTextLocation.getEnd()));
                    inputType = InputType.NORMAL;
                }
                break;
            default:
     ...
     */
    public void directWriteCharacter(char ch, TextLocation originalDocumentTextLocation) throws RtfReaderException {
        ...
        if (outputDestination != null) {
            ...
            indexListener.wroteToDestination(outputDestination.getName(), destinationIndex, originalDocumentTextLocation);
        }
    }
