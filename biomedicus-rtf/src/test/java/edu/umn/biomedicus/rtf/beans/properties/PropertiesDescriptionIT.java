...
public class PropertiesDescriptionIT {
    ...
    public void testLoadProperties() throws Exception {
        PropertiesDescription propertiesDescription = PropertiesDescription.loadFromFile("edu/umn/biomedicus/rtf/PropertiesDescription.xml");
        List<PropertyGroupDescription> propertyGroupDescriptions = propertiesDescription.getPropertyGroupDescriptions();
