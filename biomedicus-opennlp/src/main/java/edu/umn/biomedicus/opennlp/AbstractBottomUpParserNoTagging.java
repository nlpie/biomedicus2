...
/**
 * This class is copied in its entirety from OpenNLP and then modified so that it does not perform POS tagging. The
 * original class is opennlp.tools.parser.AbstractBottomUpParser
 *
 *
 * @since 1.5.0
 */
public abstract class AbstractBottomUpParserNoTagging implements Parser {
    ...
    public AbstractBottomUpParserNoTagging(POSTagger tagger, Chunker chunker, HeadRules headRules, int beamSize, double advancePercentage) {
    ...
    public Parse[] parse(Parse tokens, int numParses) {
        ...
        int derivationStage = 1; //derivation length
